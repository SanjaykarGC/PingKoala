  ...
  try {
    ...
    if (quota && quota.count >= quotaLimit) {
      return NextResponse.json(
        {
          message:
            "You have reached the 'Monthly Quota'. Please upgrade your plan for more events.",
        },
        { status: 429 }
      )
    }
    ...
    const validationResult = REQUEST_VAIDATOR.parse(requestData)
