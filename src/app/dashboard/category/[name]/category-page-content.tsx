...
import EventCategoryState from "./empty-category-state"
...
const CategoryPageContent = ({
  ...
  //https://localhost:3000/dashboard/category/sales?page=1&limit=30
    ...
    return Object.entries(numericFieldsSums).map(([field, sums]) => {
      ...
      return (
        <Card key={field}>
          ...
          <div>
            <p className="text-2xl font-bold">{relavantSum.toFixed(2)}</p>
  ...
  if (!pollingData.hasEvents) {
    return <EventCategoryState categoryName={category.name} />
  }
  return (
