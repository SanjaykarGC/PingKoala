          ...
          <div className="px-2 md-4">
            ...
            <div className="flex items-center px-2 py-1.5 rounded bg-[#393c43] text-white cursor-pointer">
              <Image
                ...
                alt="PingKoala Avatar"
                width={32}
                height={32}
                className="object-cover rounded-full mr-3"
              />
              <span className="font-medium">PingKoala</span>
            </div>
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="h-16 bg-[]#36393f flex items-center px-4 shadow-sm border-b border-[#202225]">
          ...
          <div className="flex items-center">
            ...
            <p className="font-semibold text-white">PingKoala</p>
          </div>
        ...
        <div className="p-4">
          <div className="flex items-center bg-[#40444b] rounded-lg p-1">
            ...
            <div className="flex items-center space-x-3 mx-3 text-[#b9bbbe]">
              <Gift className="size-5 hover:text-white hidden cursor-not-allowed sm:block" />
              <Sticker className="size-5 hover:text-white hidden cursor-not-allowed sm:block" />
              <Smile className="size-5 hover:text-white hidden cursor-not-allowed sm:block" />
            </div>
          </div>
        </div>
      </div>
